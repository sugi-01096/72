...
# 禁止ワードのリスト
banned_words = ["馬鹿", "バカ","死ね","シネ","アホ","ボケ","カス","ハゲ","デブ","チビ","クソ","消えろ","ぶさいく","きもい","くさい","のろま","きっしょ","殺す",
,"ゴミ","しばくぞ","ファック","ポリエマンコビッチ","ビッチ","寝取り","ゴミカス","情弱","チー牛","シャラップ","黙れ","だまれ","脳みそある？","頭動いてる？","ファッキンユー",
,"しゃべるな","話しかけてくんなよ","ばばあ","老害","きめぇ","外人","きちがい","キチガイ","人外","くせぇ","ガキ",
,"脳みそないんか","スロカス","パチンカス","パチカス","ヤニカス",]
